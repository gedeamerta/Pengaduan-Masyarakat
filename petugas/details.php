                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if($fetch_pengaduan->status == "0") : ?>
                                                        <a href="tanggapan.php?id_pengaduan=<?= $fetch_pengaduan->id_pengaduan; ?>"
                                                            class="btn btn-danger">Menunggu</a>
                                                        <?php elseif($fetch_pengaduan->status == "proses") :?>
                                                        <a href="tanggapan.php?id_pengaduan=<?= $pengaduan->id_pengaduan; ?>"
                                                            class="btn btn-info">Diproses</a>
                                                        <?php else : ?>
                                                        <a href="tanggapan.php?id_pengaduan=<?= $fetch_pengaduan->id_pengaduan; ?>"
