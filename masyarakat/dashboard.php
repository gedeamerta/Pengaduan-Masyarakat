...
$fetch_masyarakat = $classMasyarakat->fetch_masyarakat($_SESSION['username']);
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="../include/action/masyarakat/logout.php" class="nav-link"
                        ...
                        <div class="col-md-12">
                            <div class="card card-primary card-outline">
                                <div class="card-header">
                                    <h3 class="card-title">Isi Pengaduan</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <form action="../include/action/masyarakat/insert-pengaduan.php" method="POST"
                                        enctype="multipart/form-data">
                                        <input type="hidden" name="nik" value="<?= $fetch_masyarakat->nik ?>">
                                        <div class="form-group">
                                            <label for="">Ketik Pengaduan</label>
                                            <textarea name="isi_laporan" class="form-control" id="" cols="30"
                                                rows="10"></textarea>
                                        </div>
                                        <div class="form-group">
