...
$fetch_all_petugas = $classAdmin->fetch_all_petugas();
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a onclick="return confirm('Apakah anda yakin ?')"
                                                        ...
                                                        href="../include/action/admin/delete-petugas-action.php?id_petugas=<?= $petugas->id_petugas; ?>">
                                                        Delete
                                                    </a>
                                                    <a class="btn btn-info"
                                                        href="edit-petugas.php?id_petugas=<?= $petugas->id_petugas; ?>">
                                                        Edit
                                                    </a>
                                                </td>
                                            </tr>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="card card-primary card-outline">
                                ...
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <form action="../include/action/admin/add-petugas.php" method="POST">
                                        <div class="row">
